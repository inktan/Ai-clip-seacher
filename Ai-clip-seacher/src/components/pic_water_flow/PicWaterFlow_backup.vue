...
<template>
    <div class="PicWaterfallFlow-container">
        ...
        <div class="PicWaterfallFlow" id="PicWaterfallFlow" v-if="globalStore.images.length > 0">
            <div v-for="(item, index) in globalStore.images" :key="item.imgUrl">
                <el-link href="" target="" @mouseover="handleMouseOver(index)" @mouseleave="handleMouseLeave(index)"
                    ...
                    <el-image :src="item.imgUrl" @load="handleLoad(index)" lazy />
